...
/**
    ...
    */
export function random(options?: BpdRandomOptions): Promise<number>;
/**
    * Opens element in fullscreen if possible
    * @param element dom element. For full page use document.documentElement
    */
export function openFullscreen(element: Element): Promise<boolean>;
/**
    * Closes fullscreen if possible
    */
export function closeFullscreen(): Promise<boolean>;
